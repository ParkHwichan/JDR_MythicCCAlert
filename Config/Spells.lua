...
E.Config.spells = {
    -- 개인 차단 --
    [183752] = { name = "Disrupt", type = "interrupt", class = "DEMONHUNTER", cooldown = 15, priority = 120, silence = 3 },
    [47528] = { name = "Mind Freeze", type = "interrupt", class = "DEATHKNIGHT", cooldown = 15, priority = 119, silence = 3 },
    ...
    [2139] = { name = "Counterspell", type = "interrupt", class = "MAGE", cooldown = 24, priority = 113, silence = 5 },
    ...
    [78675] = { name = "빔", soundPath = "빔", ccDuration= 8, type = "aoeInterrupt", class = "DRUID", cooldown = 60, priority = 120, silence = 8 },
